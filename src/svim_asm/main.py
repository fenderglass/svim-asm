...
def main(svim_arguments):
    # Fetch command-line options
    options = parse_arguments(program_version=__version__, arguments=svim_arguments)
    ...
    logging.info("CMD: python3 {0}".format(" ".join(svim_arguments)))
...
if __name__ == "__main__":
    try:
        sys.exit(main(svim_arguments=sys.argv[1:]))
